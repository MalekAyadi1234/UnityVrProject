...
{
    public class HealthPassenger : MonoBehaviour
{
        ...
        void Update()
        {
            ...
            if (!isAiOrDummy)
            {
                if (health > 0)
                {
                    ...
                    ui.GetComponent<hudController>().uiPassHealth.text = health.ToString();
                }
                else
                {
                    GameObject ui = GameObject.FindGameObjectWithTag("hud");
                    ui.GetComponent<hudController>().uiPassHealth.text = "0";
                }
            }
        ...
        public void Damage(float damage)
        {
...

            {
                ...
                GameObject ui = GameObject.FindGameObjectWithTag("hud");
                ui.GetComponent<hudController>().uiPassHealth.text = "100";
